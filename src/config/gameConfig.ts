...
export const GAME_DETAILS_API_URL = `${API_BASE_URL.replace(/\/$/, "")}/gready-market`;
...
export const CURRENT_ROUND_API_URL = `${API_BASE_URL.replace(/\/$/, "")}/gready_market_round`;
...
drink:"gready-jackpot/gready-jackpot-big-drink.svg",
veg:"gready-jackpot/gready-jackpot-small-veg.svg",
