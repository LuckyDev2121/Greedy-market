      ...
      >
        ...
        >
          ...
          <div className="absolute w-full top-[40px]">
            <AnimatePresence>
              <motion.button key="cup-entry" className="absolute flex w-[100px] h-[100px] left-[5px]"
                initial={{ y: 0, }}
                animate={{ y: 3, }}
                transition={{
                  duration: 0.4,
                ...
                <span className="absolute font-bold left-1/2 -translate-x-1/2 top-[55px] [text-shadow:1px_0_0_brown,-1px_0_0_brown,0_1px_0_brown,0_-1px_0_brown]">{myRanking?.data.ranking_position && myRanking?.data.ranking_position > 98 ? +99 : myRanking?.data.ranking_position}</span>
              </motion.button>
