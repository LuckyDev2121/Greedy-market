                    ...
                    {historyData.map((item) => {
                        ...
                        return (
                            <div key={item.round_no} className="relative mt-[5px] bg-amber-300/30 rounded-[20px] w-[325px] h-[150px] border-t-[1px] border-t-amber-600">
                                ...
                                <span className=" absolute left-[5px] top-[130px] text-[12px] text-[#bb8000] ">Diamond Balance: {`${Number.parseInt(item.post_balance ?? "0", 10)}->${Number.parseInt(item.new_balance ?? "0", 10)}`}</span>
                            </div>
                        );
                    })}
                </div>
